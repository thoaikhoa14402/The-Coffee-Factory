...
import "./Slider.css";
import slider1 from '../../../../Image/img/slider1.png'
import slider2 from '../../../../Image/img/slider2.png'
import slider3 from '../../../../Image/img/slider3.png'
    ...
    <div className="sliderInterface">
      ...
      >
        <div className="sliderItem">
          ...
          <img src={slider1} alt="slideshow-1" />
        </div>
        <div className="sliderItem">
          {/* <img src="../../img/slider2.png" alt="slideshow-2" /> */}
          <img src={slider2} alt="slideshow-2" />
        </div>
        <div className="sliderItem">
          {/* <img src="../../img/slider3.png" alt="slideshow-3" /> */}
          <img src={slider3} alt="slideshow-3" />
        </div>
      </div>
