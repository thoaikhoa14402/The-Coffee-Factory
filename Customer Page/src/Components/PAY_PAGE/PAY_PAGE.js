      ...
      <div className='shipDetails'>
        ...
        <div className='informationT'>
          <div className='in'>
            ...
            {!order && <input onChange={enteredName} spellCheck='false' className='inputT' placeholder='Họ và tên người nhận' />}
          ...
          <div className='in'>
            ...
            {!order && <input onChange={enteredPhone} spellCheck='false' className='inputT' placeholder='Số điện thoại người nhận' />}
          ...
          {options === 1 && <div className='in'>
            ...
            {!order && <input onChange={enteredAddress} spellCheck='false' className='inputT' placeholder='Địa chỉ người nhận' />}
