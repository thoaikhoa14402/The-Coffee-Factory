        ...
        <div className={`navbar-container ${hidden && 'hidden'}`}>
            <div className='container-details'>
                ...
                <div className='detail-describe'>
                    ...
                    <p className={`detail-describe-p ${page === 5 && 'setChoose'}`} onClick={() => props.footer.current.scrollIntoView({ behavior: 'smooth' })}>LIÊN HỆ</p>
                </div>
            </div>
            ...
            <div className='search-icons'>
                ...
                <div className='search-form' onClick={() => navigate('/products')}>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_1653_710)">
                ...
                <div className='shop-icons'>
                    <div onClick={() => navigate('/payments')} className='icon-shopping'>
                        {/* {props.CartLength > 0 && <span className='dot'></span>} */}
                        <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_361_254)">
                ...
                {logined && <div onClick={() => navigate('/user')} className='imageUser'>
                    <img src={avatar} alt='' />
                </div>}
