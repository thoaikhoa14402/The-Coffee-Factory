...
import logo_footer from '../../../Image/img/logo_footer.png'
import qrcode from '../../../Image/img/qrcode.png'
    ...
    <div ref={refs}>
      <div className={style.footer_container}>
        <div className={style.info_company}>
          <div>
            <h1 className={style.info_title}>THÔNG TIN</h1>
          </div>
          <div className={style.logo_footer}>
            <img className={style.img_logo} src={logo_footer} alt="logo" />
          </div>

          <div className={style.time_open_close}>
          ...
          <div className={style.text_phone}>
          ...
          <div className={style.connect_web}>
            <div className={style.icon_web}>
              <svg
                width="13"
                height="14"
                viewBox="0 0 13 14"
          ...
          <div className={style.connect_mail}>
            <div className={style.icon_mail}>
              <svg
                width="13"
                height="11"
                viewBox="0 0 13 11"
          ...
          <div className={style.address}>
            <div className={style.icon_address}>
              <svg
                width="11"
                height="14"
                viewBox="0 0 11 14"
        ...
        <div className={style.quick_link}>
          <h2 className={style.title_link}>LIÊN KẾT NHANH</h2>
        ...
        <div className={style.provision}>
          <h2 className={style.title_provision}>ĐIỀU KHOẢN</h2>
          <div className={style.detail_rules}>
            <p>Điều kiện sử dụng</p>
            <p>Quy tắc bảo mật</p>
            <img className={style.QR} src={qrcode} alt="QR" />
          </div>
        </div>
        <div className={style.subscribe}>
          <h2 className={style.title_subscribe}>ĐĂNG KÝ NHẬN BẢN TIN</h2>
          <div className={style.description_sub}>
            <p>
          ...
          <div className={style.input_info}>
            ...
            <input
              ...
              placeholder="Email"
            ></input>
            <button className={style.button_sub} type="button">
              ĐĂNG KÝ
            </button>
          </div>
        </div>
