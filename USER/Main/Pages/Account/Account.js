...
function Account(props) {
  ...
  return (
    <div className='Account'>
      ...
      <div className='information'>
        {props.page === 1 && <div className='form1'>
          ...
          <div className='text'>
            ...
            <input onChange={handleChangeBirthDay} value={birthDay} className='inputt' placeholder='dd/mm/yyyy' />
          </div>
          <div className='text'>
            <div className='form-title star'>
              <p>Số điện thoại</p>
            ...
            <input onChange={handleChangePhone} value={numberPhone} className='inputt' placeholder='Nhập số điện thoại' />
          </div>
          <div className='text'>
            <div className='form-title star'>
              <p>Email</p>
            ...
            <input onChange={handleChangeEmail} value={email} className='inputt' placeholder='Nhập email' />
          </div>
          <div className='text'>
        ...
        {props.page === 2 && !resetPassSuccess && <div className='form2'>
      ...
      {props.page === 1 && resetSuc && <button onClick={handleResetInformation} className='save Ssuc'>lưu thành công</button>}
      {props.page === 2 && !resetPassSuccess && <button onClick={handleResetPassword} className='save'>lưu thay đổi</button>}
