...
import bg_header from '../../Image/imgStore/bg_header.png'
import img_describe from '../../Image/imgStore/img_describe.png'
import Portrait from '../../Image/imgStore/Portrait.png'

const IntroducePage = ({ refs }) => {
    return (
        <div className={style.container}>

            <div className={style.img__store}>
                <div className={style.backgroud_header}>
                    <img src={bg_header} placeholder='backgroud header' />
                </div>
            </div>

            <div className={style.content__store}>
                <div className={style.content__store__tittle}>
                    <p>LỜI GIỚI THIỆU</p>
                </div>
                <div className={style.content__store__tittle_content}>
                ...
                <div className={style.title_persion}>
                ...
                <div className={style.img_content}>
                    <div className={style.img_coffee} >
                        <img src={img_describe} />
                    </div>

                    <div className={style.content_side}>
                        <p className={style.p3}>Đi tìm mô hình “nhà máy”</p>
                        <p className={style.p3}>Tháng 11/2013, cửa hàng The Coffee Factory đầu tiên bắt đầu hoạt động ngay mặt tiền đường Trương Định, TP.HCM với phong cách khá lạ mắt:
                        ...
                        <p className={style.p3}>Nguyễn Xuân Quốc Việt chia sẻ lý do chọn thiết kế này: Một cửa hàng cà phê khác biệt phải có gu riêng về phong cách và vị cà phê trung thực.</p>

                    </div>
                </div>

                <div className={style.describe_content}>
                    <p className={style.content_p3}>Việt Nam là một trong những nước xuất khẩu cà phê lớn trên thế giới nhưng muốn thưởng thức một ly cà phê ngon thường phải vào những cửa hàng mang thương hiệu ngoại với mức giá khá cao.
